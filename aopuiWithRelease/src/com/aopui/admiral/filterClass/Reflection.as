package com.aopui.admiral.filterClass {
	...
	public class Reflection extends Sprite {
		...
		public function getReflection(set_disTarget:DisplayObject, set_numStartFade:Number, set_numMidLoc:Number, set_numEndFade:Number, set_numSkewX:Number, set_numScale:Number) 
		:DisplayObject
		{
		...
		private function createReflection(event:Event = null):DisplayObject {
